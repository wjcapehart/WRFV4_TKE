...
/* "build mode_graphics" */
/* #undef ENABLE_MODE_GRAPHICS */

/* "build mode_time_domain" */
...
/* "build plot_data_plane" */
#define ENABLE_PLOT_DATA_PLANE /**/

/* "build plot_point_obs" */
...
/* "build series_analysis" */
#define ENABLE_SERIES_ANALYSIS /**/

/* "build shift_data_plane" */
...
#define PACKAGE_BUGREPORT "met_help@ucar.edu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MET"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MET 8.0"
